...
export const SeoSection = (): JSX.Element => {
  ...
  return (
    <section className="w-full bg-[linear-gradient(157deg,rgba(171,131,226,1)_0%,rgba(76,52,127,1)_50%,rgba(9,2,39,1)_100%),linear-gradient(171deg,rgba(248,245,255,1)_0%,rgba(236,227,252,1)_50%,rgba(46,34,94,1)_100%)] py-12 md:py-20">
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          <div className="flex flex-col w-full lg:flex-1 items-start gap-7">
            ...
            <h1 className="[font-family:'DM_Sans',Helvetica] font-bold text-white text-3xl md:text-5xl lg:text-6xl tracking-[0] leading-tight">
              Mensagens de Rastreio Automatizadas via WhatsApp
            </h1>

            <div className="w-full [font-family:'DM_Sans',Helvetica] font-normal text-lg md:text-xl tracking-[0] leading-7">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full">
              <Button className="h-12 px-6 md:px-8 bg-[#ab6afb] hover:bg-[#9b5aeb] rounded-2xl shadow-[0px_25px_50px_-12px_#00000040] w-full sm:w-auto">
              ...
              <Button
                variant="outline"
                className="h-[52px] px-6 md:px-8 bg-[#f8f5ff] hover:bg-[#ece3fc] rounded-2xl border-2 border-solid border-white w-full sm:w-auto"
              >
          ...
          <div className="hidden lg:flex items-center justify-center w-full lg:flex-1">
