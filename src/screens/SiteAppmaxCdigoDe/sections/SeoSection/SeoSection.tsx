...
export const SeoSection = (): JSX.Element => {
  const avatarImages = [{ src: "/group-24.png", alt: "User 1" }];

  return (
    <section className="flex items-center justify-between px-4 md:px-16 lg:px-[268px] py-[84px] bg-[linear-gradient(157deg,rgba(171,131,226,1)_0%,rgba(76,52,127,1)_50%,rgba(9,2,39,1)_100%),linear-gradient(171deg,rgba(248,245,255,1)_0%,rgba(236,227,252,1)_50%,rgba(46,34,94,1)_100%)] w-full">
      <div className="flex flex-col max-w-[717px] items-start gap-7">
        <Badge className="h-auto px-[18px] py-3 bg-[#ddc3fd] rounded-full border border-solid border-[#ffffff33] hover:bg-[#ddc3fd]">
        ...
        <h1 className="[font-family:'DM_Sans',Helvetica] font-bold text-white text-6xl tracking-[0] leading-[60px]">
          Mensagens de Rastreio Automatizadas via WhatsApp
        </h1>

        <div className="max-w-[671px] [font-family:'DM_Sans',Helvetica] font-normal text-xl tracking-[0] leading-7">
        ...
        <div className="flex items-center gap-4 flex-wrap">
          <Button className="h-12 px-8 bg-[#ab6afb] hover:bg-[#9b5aeb] rounded-2xl shadow-[0px_25px_50px_-12px_#00000040]">
          ...
          <Button
            variant="outline"
            className="h-[52px] px-8 bg-[#f8f5ff] hover:bg-[#ece3fc] rounded-2xl border-2 border-solid border-white"
          >
        ...
        <div className="flex items-start gap-6">
          <img className="w-[136px] h-10" alt="Group" src="/group-24.png" />
      ...
      <div className="flex items-center gap-2.5 flex-shrink-0">
        <div className="relative w-[488px] h-[556px]">
          <div className="absolute top-[29px] left-0 w-[488px] h-[500px]">
            <div className="absolute top-0 left-0 w-[488px] h-[500px] flex rounded-3xl overflow-hidden shadow-[0px_25px_50px_-12px_#00000040] bg-[linear-gradient(134deg,rgba(171,106,251,1)_0%,rgba(117,76,200,1)_100%)]">
              <div className="flex-1 w-[488px] rounded-3xl bg-[linear-gradient(134deg,rgba(255,255,255,0.1)_0%,rgba(255,255,255,0)_100%)]" />
            </div>
          ...
          <img
            className="absolute top-0 left-[87px] w-[315px] h-[556px]"
