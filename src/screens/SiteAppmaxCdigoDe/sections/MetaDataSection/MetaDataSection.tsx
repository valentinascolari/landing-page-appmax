...
export const MetaDataSection = (): JSX.Element => {
  return (
    <section className="w-full bg-white py-16 md:py-24 lg:py-32">
      ...
      <div className="flex w-full lg:flex-1 items-start gap-12 md:gap-16 lg:gap-20 flex-col">
        <div className="flex items-start gap-6 md:gap-8 flex-col w-full">
          ...
          <div className="flex items-center justify-start gap-2.5 w-full">
            <h2 className="[font-family:'DM_Sans',Helvetica] font-bold text-[#251e48] text-3xl md:text-4xl lg:text-5xl tracking-[0] leading-tight">
              A inteligência que
              <br />
              aprova a sua venda,
              <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
          {featureCards.map((card, index) => (
            <Card
              key={index}
              className="w-full rounded-2xl border-2 border-[#dcc3fe] bg-[linear-gradient(153deg,rgba(249,245,255,1)_0%,rgba(237,226,254,1)_100%)]"
            >
      ...
      <div className="flex flex-col w-full lg:flex-1 items-center lg:items-start gap-2.5">
        <img
          className="w-full max-w-md lg:max-w-full h-auto object-cover rounded-lg"
          alt="Imagem"
          src="/imagem.png"
        />
      </div>
